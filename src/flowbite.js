                        ...
                        value: function (e) {
                            ...
                            this._options.alwaysOpen ||
                                this._items.map(function (e) {
                                    ...
                                    e !== o &&
                                        ((r =
                                            e.triggerEl.classList).remove.apply(
                                            r,
                                            t(
                                        ...
                                        e.triggerEl.setAttribute(
                                            "aria-expanded",
                                            !1
                                        ),
                                        (e.active = !1),
                                        e.iconEl &&
                                            e.iconEl.classList.remove(
                                                "rotate-180"
                                            ));
                                }),
                                ...
                                (o.active = !0),
                                o.iconEl &&
                                    o.iconEl.classList.add("rotate-180"),
                        ...
                        value: function (t) {
                            ...
                            (this._activeItem = this._items[t]),
                                this._indicators.length &&
                                    ...
                                    this._indicators[t].el.setAttribute(
                                        "aria-current",
                                        "true"
                                    ));
                        },
            ...
            : St(
                  (function (t) {
                      ...
                      return (
                          "rtl" === N(i || r).direction &&
                              (s +=
                                  H(r.clientWidth, i ? i.clientWidth : 0) - o),
            ...
            if (O) {
                if (o) {
                    var L,
                        ...
                        F = Ht(0, E[C], U[C]),
                        Y = m
                            ? E[C] / 2 - M - F - N - A.mainAxis
                            : W - F - N - A.mainAxis,
                        G = m
                            ? -E[C] / 2 + M + F + $ + A.mainAxis
                            : R + F + $ + A.mainAxis,
    ...
    var tr = new Ze("load", [
        ...
        function () {
            document.querySelectorAll("[data-carousel]").forEach(function (t) {
                ...
                t.querySelectorAll("[data-carousel-item]").length &&
                    v(t.querySelectorAll("[data-carousel-item]")).map(function (
                        t,
                        e
                    ) {
                ...
                t.querySelectorAll("[data-carousel-slide-to]").length &&
                    v(t.querySelectorAll("[data-carousel-slide-to]")).map(
                        function (t) {
                            o.push({
            ...
            document
                ...
                .forEach(function (t) {
                    var e = document.querySelector(
                        t.getAttribute("data-dismiss-target")
                    );
                    new T(e, { triggerEl: t });
                });
        },
            ...
            document
                ...
                .forEach(function (e) {
                    var r = document.getElementById(
                            e.getAttribute("data-drawer-target")
                        ),
                        n = r.id,
        ...
        function () {
            document
                ...
                .forEach(function (t) {
                    var e = document.getElementById(
                            t.getAttribute("data-tooltip-target")
                        ),
        ...
        function () {
            document
                ...
                .forEach(function (t) {
                    var e = document.getElementById(
                            t.getAttribute("data-popover-target")
                        ),
            ...
            document.querySelectorAll("[data-dial-init]").forEach(function (t) {
                var e = t.querySelector("[data-dial-toggle]"),
                    r = document.getElementById(
                        e.getAttribute("data-dial-toggle")
                    ),
